...
export class PhotoController{
  static async readAllByAdvertId(req: Request, res: Response): Promise<any> {
    try {
      const { id } = req.params;
  ...
  static async createPhoto(req: Request, res: Response): Promise<any> {
    try{
  ...
  static async deletePhoto(req: Request, res: Response): Promise<any> {
    try {
      const { id } = req.params;
